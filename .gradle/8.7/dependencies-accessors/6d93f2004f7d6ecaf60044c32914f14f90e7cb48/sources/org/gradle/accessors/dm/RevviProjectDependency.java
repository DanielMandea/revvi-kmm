...
@NonNullApi
public class RevviProjectDependency extends DelegatingProjectDependency {

    @Inject
    public RevviProjectDependency(TypeSafeProjectDependencyFactory factory, ProjectDependencyInternal delegate) {
